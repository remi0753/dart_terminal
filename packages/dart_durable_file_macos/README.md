...
Callers inject an absolute directory, simple leaf names, and bytes. The package
owns descriptor-relative type/owner/link checks, 0700/0600 permission narrowing,
