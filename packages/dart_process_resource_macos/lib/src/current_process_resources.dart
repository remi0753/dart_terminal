...
/// A content-free snapshot of resources owned by the current process.
final class MacosCurrentProcessResourceSnapshot {
  const MacosCurrentProcessResourceSnapshot({
...
/// Samples current-process CPU time, resident memory, and descriptor count.
///
/// No descriptor identity, process ID, command, path, environment, or
/// application data is retained.
final class MacosCurrentProcessResourceSampler {
  ...
  MacosCurrentProcessResourceSnapshot snapshot() {
    ...
    try {
      ...
      return MacosCurrentProcessResourceSnapshot(
