...
| VT-28 | xterm version, mode, and status-string reports | `MANUAL` | DECRQSS SGR is byte/split-tested and raw product-specific serialization remains visible. Use this unit manually for the following XTVERSION/window-size policy and other status strings. |
