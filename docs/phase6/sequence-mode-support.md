...
| `ghostty:osc:osc-133` | `OSC 133 ; Ps [; Pt] ST` | The bounded A/B/C/D/I/L/N/P lifecycle projects privacy-safe shell state, row flags, and exact prompt/command/output ranges over stable logical anchors; I is line-feed scoped, L/N follow fresh-line semantics, evicted anchors are unavailable, and options and command text are never decoded or retained. |
