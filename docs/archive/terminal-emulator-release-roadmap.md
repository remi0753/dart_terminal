# Archived roadmap: terminal emulator and distribution release

> 2026-09-20 に主要ゴール達成済みの計画としてアーカイブした。
> この文書は現在の作業順序を定めない。未完了の低優先 follow-up 5件は履歴として
> 意図的に未完了のまま保持している。現在の順序は repository root の
...
`d4d8f62262cb1a974a7d2470d5f79f811fab15e4`<br>
...
[`docs/phase0/DT-012-build-ci-design.md`](../phase0/DT-012-build-ci-design.md)
...
- [x] arm64/x86_64 の build matrix と Universal Binary 組み立て（M1-native、
  ...
  [`docs/phase1/universal-runtime-matrix.md`](../phase1/universal-runtime-matrix.md)）
- [x] VM/isolate の起動、error、uncaught exception、shutdown contract
- [x] 公開・未改変の Dart だけを使う runtime hosting へ移行する（順序と
  判定基準は [`docs/phase1/stock-dart-runtime-migration-plan.md`](../phase1/stock-dart-runtime-migration-plan.md)
  を正本として固定する）
...
- [x] generic `View`、focus、visibility、occlusion、backing scale、screen event
  （分割と完了条件は
  [`docs/phase1/generic-view-window-state-events.md`](../phase1/generic-view-window-state-events.md)
  を参照して実施する）
...
- [x] menu、pasteboard、application/window lifecycle API
  （分割と完了条件は
  [`docs/phase1/menu-pasteboard-lifecycle-apis.md`](../phase1/menu-pasteboard-lifecycle-apis.md)
  を参照して実施する）
...
- [x] TerminalMetalView を attach できる generic custom-view boundary
  （分割と完了条件は
  [`docs/phase1/terminal-metal-view-boundary.md`](../phase1/terminal-metal-view-boundary.md)
  を参照して実施する）
...
- [x] macOS unified logging と local crash metadata
  （分割と完了条件は
  [`docs/phase1/macos-unified-logging-crash-metadata.md`](../phase1/macos-unified-logging-crash-metadata.md)
  を参照して実施する）
...
- [x] native/Dart の resource leak test と shutdown fault injection
  （分割と完了条件は
  [`docs/phase1/resource-leak-shutdown-fault-injection.md`](../phase1/resource-leak-shutdown-fault-injection.md)
  を参照して実施する）
...
- [x] Dart-only application packaging boundary の目標、成果物、依存順、受け入れ条件を
  固定する（以後の7項目は
  [`docs/phase2/dart-only-application-packaging.md`](../phase2/dart-only-application-packaging.md)
  を参照して順に実施する）
...
- [x] session ID と pane ownership、close confirmation state
  （分割と完了条件は
  [`docs/phase2/persistent-pane-lifecycle.md`](../phase2/persistent-pane-lifecycle.md)
  を参照して順に実施する）
...
- [x] Ctrl-D / PTY shutdown hang の bounded recovery
  （分割と完了条件は
  [`docs/phase2/ctrl-d-pty-shutdown-recovery.md`](../phase2/ctrl-d-pty-shutdown-recovery.md)
  を参照して順に実施する）
...
- [x] AppKit key event routing policy とterminal専有入力
  （分割と完了条件は
  [`docs/phase2/exclusive-key-event-routing.md`](../phase2/exclusive-key-event-routing.md)
  を参照して順に実施する）
...
- [x] Ctrl-D write受理後のPTY停止原因を分離する
  （実施時に
  [`docs/phase2/ctrl-d-accepted-no-exit-investigation.md`](../phase2/ctrl-d-accepted-no-exit-investigation.md)
  を参照する）
- [x] Dart `Process.start` workerとnative PTY childのreap ownership競合を解消する
  （実施時に
  [`docs/phase2/pty-child-reap-ownership-conflict.md`](../phase2/pty-child-reap-ownership-conflict.md)
  を参照する）
...
- [x] typed-array grid、cursor、margins、tabstops、modes
  - [x] typed-array cell/row storage、cursor/save、tabstop、damage基盤
    （[`docs/phase3/typed-array-grid-screen-state.md`](../phase3/typed-array-grid-screen-state.md) を参照して実施）
...
- [x] SGR、palette、primary/alternate screen
  - [x] style table、rendition state、SGR application
    （[`docs/phase3/sgr-palette-primary-alternate-screen.md`](../phase3/sgr-palette-primary-alternate-screen.md) を参照して実施）
...
- [x] wide/grapheme cells と resize/reflow
  - [x] Unicode 17 properties、grapheme breaker、bounded intern table
    （[`docs/phase3/wide-grapheme-resize-reflow.md`](../phase3/wide-grapheme-resize-reflow.md) を参照して実施）
...
- [x] paged scrollback、viewport、selection/search primitives
  - [x] fixed-page bounded scrollback storage と primary full-screen capture
    （[`docs/phase3/paged-scrollback-viewport-selection-search.md`](../phase3/paged-scrollback-viewport-selection-search.md) を参照して実施）
...
- [x] query/reply encoder と PTY write connection
  - [x] bounded reply encoder と terminal-core query dispatch
    （[`docs/phase3/query-reply-pty-write.md`](../phase3/query-reply-pty-write.md) を参照して実施）
...
- [x] snapshot formatter と readable test diagnostics
  - [x] bounded versioned terminal-state formatter
    （[`docs/phase3/snapshot-formatter-test-diagnostics.md`](../phase3/snapshot-formatter-test-diagnostics.md) を参照して実施）
...
- [x] parser corpus、property tests、fuzz seeds
  - [x] bounded product corpus manifest と replay harness
    （[`docs/phase3/parser-corpus-property-fuzz.md`](../phase3/parser-corpus-property-fuzz.md) を参照して実施）
...
- [x] headless/reference renderer と golden image format
  - [x] bounded headless RGBA surface と reference layer compositor
    （[`docs/phase4/reference-renderer-golden-format.md`](../phase4/reference-renderer-golden-format.md) を参照して実施）
...
- [x] CoreText font catalog、fallback、metrics、shaping cache
  - [x] versioned font catalog、style/fallback resolution、cell metrics
    （[`docs/phase4/coretext-font-shaping.md`](../phase4/coretext-font-shaping.md) を参照して実施）
...
- [x] monochrome/color glyph atlas
  - [x] bounded batched CoreText monochrome/color glyph raster ABI
    （[`docs/phase4/glyph-raster-atlas.md`](../phase4/glyph-raster-atlas.md) を参照して実施）
...
- [x] Metal cell/glyph/decoration/cursor/selection pipelines
  - [x] packed native pipeline、precompiled shader、atlas texture capability
    （[`docs/phase4/metal-pipelines.md`](../phase4/metal-pipelines.md) を参照して実施）
...
- [x] damage coalescing、frame generation、stale-frame discard
  - [x] strict damage codec と retained render model
    （[`docs/phase4/damage-frame-coordinator.md`](../phase4/damage-frame-coordinator.md) を参照して実施）
  - [x] 100,000-cell product damage capture/transfer の Release AOT gate
    （[`docs/phase4/damage-capture-performance.md`](../phase4/damage-capture-performance.md) を参照して実施）
...
- [x] resize/scale/font change の full rebuild
  - [x] coalesced rebuild state と full-snapshot epoch ownership
    （[`docs/phase4/resize-scale-font-rebuild.md`](../phase4/resize-scale-font-rebuild.md) を参照して実施）
...
- [x] cursor blink、visual bell、occlusion pause
  - [x] cursor/BEL presentation metadata を strict damage protocol へ追加
    （[`docs/phase4/cursor-bell-occlusion.md`](../phase4/cursor-bell-occlusion.md) を参照して実施）
...
- [x] device/shader/drawable failure recovery
  - [x] typed native Metal failure state と drawable retry contract
    （[`docs/phase4/metal-failure-recovery.md`](../phase4/metal-failure-recovery.md) を参照して実施）
...
- [x] frame timing、atlas hit rate、uploaded byte count の metrics
  （[`docs/phase4/renderer-metrics.md`](../phase4/renderer-metrics.md) を参照して実施）
...
- [x] default Metal terminal surface と wrap-aware live viewport の製品統合
  （[`docs/phase4/product-metal-surface-integration.md`](../phase4/product-metal-surface-integration.md) を参照して実施）
...
- [x] macOS system monospace と標準サイズをzero-config既定値にする
  （[`docs/phase4/macos-system-default-font.md`](../phase4/macos-system-default-font.md) を参照して実施）
- [x] CoreText glyph atlas の上下反転を修正し実GUI画像で判読性を確認する
  （[`docs/phase4/glyph-raster-orientation.md`](../phase4/glyph-raster-orientation.md) を参照して実施）
- [x] zero-config既定フォントサイズを14ptへ拡大し実GUIで判読性を確認する
  （[`docs/phase4/larger-default-font-size.md`](../phase4/larger-default-font-size.md) を参照して実施）
- [x] scroll中のglyph垂直クリップを解消し、viewport移動後も行全体を安定表示する
  （[`docs/phase4/scroll-glyph-vertical-clipping.md`](../phase4/scroll-glyph-vertical-clipping.md)
  を参照して実施する）
...
- [x] mode-aware key encoder と configurable keybind engine
  （[`docs/phase5/mode-aware-key-input.md`](../phase5/mode-aware-key-input.md) を参照して実施）
...
- [x] `NSTextInputClient` と preedit overlay
  （[`docs/phase5/text-input-client-preedit.md`](../phase5/text-input-client-preedit.md) を参照して実施）
...
- [x] US/JIS/dead key/CJK/emoji/key repeat matrix
  （[`docs/phase5/input-source-matrix.md`](../phase5/input-source-matrix.md) を参照して実施）
- [x] mouse protocol と local selection arbitration
  （[`docs/phase5/mouse-protocol-selection-arbitration.md`](../phase5/mouse-protocol-selection-arbitration.md) を参照して実施）
...
- [x] character/word/line selection、drag autoscroll
  （[`docs/phase5/selection-gesture-autoscroll.md`](../phase5/selection-gesture-autoscroll.md) を参照して実施）
...
- [x] precision trackpad scroll
  （[`docs/phase5/precision-trackpad-scroll.md`](../phase5/precision-trackpad-scroll.md) を参照して実施）
...
- [x] clipboard、bracketed paste、paste safety
  （[`docs/phase5/clipboard-bracketed-paste-safety.md`](../phase5/clipboard-bracketed-paste-safety.md) を参照して実施）
...
- [x] hyperlink hover/open と URL safety
  （[`docs/phase5/hyperlink-hover-open-url-safety.md`](../phase5/hyperlink-hover-open-url-safety.md) を参照して実施）
...
- [x] VoiceOver の最小 visible text/selection/cursor support
  （[`docs/phase5/voiceover-visible-text-selection-cursor.md`](../phase5/voiceover-visible-text-selection-cursor.md) を参照して実施）
...
- [x] CJK wide-cellの表示幅・pointer selection・clipboard抽出を一致させる
  （[`docs/phase5/cjk-wide-cell-selection-copy-geometry.md`](../phase5/cjk-wide-cell-selection-copy-geometry.md) を参照して実施）
- [x] 初回window close requestでscroll viewport位置を変更しない
  （[`docs/phase5/window-close-scroll-position.md`](../phase5/window-close-scroll-position.md) を参照して実施）
...
- [x] ECMA-48、DEC、xterm の sequence/mode inventory
  （[`docs/phase6/sequence-mode-inventory.md`](../phase6/sequence-mode-inventory.md) を参照して実施）
...
- [x] xterm/Ghostty/Kitty との black-box differential harness
  （[`docs/phase6/black-box-differential-harness.md`](../phase6/black-box-differential-harness.md) を参照して実施）
...
- [x] `vttest` を参考に採用/非採用項目を明文化
  （[`docs/phase6/vttest-adoption.md`](../phase6/vttest-adoption.md) を参照して実施）
- [x] tmux、ssh、mosh、Neovim、Emacs、ncurses、fzf、lazygit の matrix
  （[`docs/phase6/vttest-adoption.md`](../phase6/vttest-adoption.md) のadoption判断も参照して実施）
  （[`docs/phase6/real-application-compatibility-matrix.md`](../phase6/real-application-compatibility-matrix.md) を参照して実施）
...
- [x] terminfo source、compile/install/fallback
  （[`docs/phase6/vttest-adoption.md`](../phase6/vttest-adoption.md) のcharacter-set判断も参照して実施）
  （[`docs/phase6/real-application-compatibility-matrix.md`](../phase6/real-application-compatibility-matrix.md) のcharacter-set/XTGETTCAP gapを参照して実施）
  （[`docs/phase6/terminfo-source-compile-install-fallback.md`](../phase6/terminfo-source-compile-install-fallback.md) を参照して実施）
...
- [x] OSC title/cwd/hyperlink/palette/clipboard policy
  （[`docs/phase6/vttest-adoption.md`](../phase6/vttest-adoption.md) のtitle判断も参照して実施）
  （[`docs/phase6/real-application-compatibility-matrix.md`](../phase6/real-application-compatibility-matrix.md) のtitle-stack gapを参照して実施）
...
- [x] focus/mouse/bracketed paste/query reports
  （[`docs/phase6/decrqss-sgr-gap.md`](../phase6/decrqss-sgr-gap.md) のgapを参照して実施）
  （[`docs/phase6/vttest-adoption.md`](../phase6/vttest-adoption.md) のmanual項目も参照して実施）
  （[`docs/phase6/real-application-compatibility-matrix.md`](../phase6/real-application-compatibility-matrix.md) のfocus/mouse/query gapを参照して実施）
  （[`docs/phase6/focus-mouse-bracketed-paste-query-reports.md`](../phase6/focus-mouse-bracketed-paste-query-reports.md) の順序と完了条件を参照して実施）
...
- [x] parser inspector と sequence trace export
  （[`docs/phase6/parser-inspector-sequence-trace-export.md`](../phase6/parser-inspector-sequence-trace-export.md) の順序と完了条件を参照して実施）
...
- [x] compatibility bug の regression corpus 化
  （[`docs/phase6/vttest-adoption.md`](../phase6/vttest-adoption.md) のadoption判断も参照して実施）
  （[`docs/phase6/compatibility-regression-corpus.md`](../phase6/compatibility-regression-corpus.md) の順序と完了条件を参照して実施）
...
- [x] test-only compatibility fixture と product native-source audit を分離する
  （実施時に
  [`docs/phase7/test-fixture-source-audit.md`](../phase7/test-fixture-source-audit.md)
  を参照する）
- [x] window → tab → split tree → terminal session の state model
  （分割と完了条件は
  [`docs/phase7/application-state-model.md`](../phase7/application-state-model.md)
  を参照して順に実施する）
...
- [x] native tabs と split layout/focus/resize/zoom
  （分割と完了条件は
  [`docs/phase7/native-tabs-split-layout-focus.md`](../phase7/native-tabs-split-layout-focus.md)
  を参照して順に実施する）
...
- [x] menu/action registry と command palette
  （分割と完了条件は
  [`docs/phase7/menu-action-registry-command-palette.md`](../phase7/menu-action-registry-command-palette.md)
  を参照して順に実施する）
...
- [x] title、tab rename/color、cwd inheritance、proxy icon
  （分割と完了条件は
  [`docs/phase7/title-tab-metadata-cwd-proxy-icon.md`](../phase7/title-tab-metadata-cwd-proxy-icon.md)
  を参照して順に実施する）
...
- [x] fullscreen、screen migration、restoration、reopen
  （分割と完了条件は
  [`docs/phase7/fullscreen-screen-migration-restoration-reopen.md`](../phase7/fullscreen-screen-migration-restoration-reopen.md)
  を参照して順に実施する）
...
- [x] per-pane close と app quit confirmation
  （分割と完了条件は
  [`docs/phase7/per-pane-close-app-quit-confirmation.md`](../phase7/per-pane-close-app-quit-confirmation.md)
  を参照して順に実施する）
...
- [x] multiple pane の scheduling/resource budget
  （分割と完了条件は
  [`docs/phase7/multiple-pane-scheduling-resource-budget.md`](../phase7/multiple-pane-scheduling-resource-budget.md)
  を参照して順に実施する）
  ...
  - [x] full-matrix Release AOT resource auto-close sequencing 回帰
    （[`docs/phase7/runtime-resource-close-sequence-blocker.md`](../phase7/runtime-resource-close-sequence-blocker.md)
    を参照して実施する）
  - [x] cross-pane flood/input 両 runtime 回帰受け入れと親項目完了判定
- [x] AppKit unit、integration、UI tests
  （分割と完了条件は
  [`docs/phase7/appkit-unit-integration-ui-tests.md`](../phase7/appkit-unit-integration-ui-tests.md)
  を参照して順に実施する）
...
- [x] 通常起動でwindow/tab/splitのuser actionを有効にする
  （分割と完了条件は
  [`docs/phase7/user-facing-window-tab-split-actions.md`](../phase7/user-facing-window-tab-split-actions.md)
  を参照して順に実施する）
...
- [x] theme/palette/font/window/input/scrollback options
  （分割と完了条件は
  [`docs/phase8/product-option-families.md`](../phase8/product-option-families.md)
  を参照して順に実施する）
...
- [x] declarative keybind と action reference generation
  （分割と完了条件は
  [`docs/phase8/declarative-keybind-action-reference.md`](../phase8/declarative-keybind-action-reference.md)
  を参照して順に実施する）
...
- [x] safe reload、per-option live/new-session policy
  （分割と完了条件は
  [`docs/phase8/safe-configuration-reload.md`](../phase8/safe-configuration-reload.md)
  を参照して順に実施する）
...
- [x] light/dark theme と system appearance
  （分割と完了条件は
  [`docs/phase8/light-dark-system-appearance.md`](../phase8/light-dark-system-appearance.md)
  を参照して順に実施する）
...
- [x] zsh/bash/fish/nushell integration
  （分割と完了条件は
  [`docs/phase8/shell-integration.md`](../phase8/shell-integration.md)
  を参照して順に実施する）
...
- [x] cwd/title/prompt mark/jump-to-prompt/close hint
  （[`docs/phase8/cwd-title-prompt-mark-close-hint.md`](../phase8/cwd-title-prompt-mark-close-hint.md)
  を参照して順に実施する）
...
- [x] settings UI と effective-config inspector
  （[`docs/phase8/settings-effective-config-inspector.md`](../phase8/settings-effective-config-inspector.md)
  を参照して順に実施する）
...
- [x] schema-complete modal settings editor と contextual detail panel
  （[`docs/phase8/editable-settings-editor.md`](../phase8/editable-settings-editor.md)
  を参照して順に実施する）
...
- [x] unavailable file option の default fallback と startup recovery
  （[`docs/phase8/configuration-value-fallback.md`](../phase8/configuration-value-fallback.md)
  を参照して順に実施する）
...
- [x] zero-config terminal と Settings editor の default typography 統一
  （[`docs/phase8/shared-terminal-settings-typography.md`](../phase8/shared-terminal-settings-typography.md)
  を参照して実施する）
- [x] Retina 実表示での terminal / Settings typography parity
  （[`docs/phase8/retina-font-rendering-parity.md`](../phase8/retina-font-rendering-parity.md)
  を参照して順に実施する）
...
- [x] Settings editor の disabled-line / cursor-line visual clarity
  （[`docs/phase8/settings-editor-visual-clarity.md`](../phase8/settings-editor-visual-clarity.md)
  を参照して順に実施する）
...
- [x] Settings editor の NORMAL/SEARCH selection viewport follow
  （[`docs/phase8/settings-editor-selection-viewport-follow.md`](../phase8/settings-editor-selection-viewport-follow.md)
  を参照して順に実施する）
...
- [x] Settings editor の initial document presentation
  （[`docs/phase8/settings-editor-initial-document-presentation.md`](../phase8/settings-editor-initial-document-presentation.md)
  を参照して順に実施する）
...
- [x] Kitty keyboard protocol
  （[`docs/phase6/real-application-compatibility-matrix.md`](../phase6/real-application-compatibility-matrix.md) のinput protocol gapを参照して実施）
  （分割と完了条件は
  [`docs/phase9/kitty-keyboard-protocol.md`](../phase9/kitty-keyboard-protocol.md)
  を参照して順に実施する）
...
- [x] synchronized output/rendering
  （[`docs/phase6/real-application-compatibility-matrix.md`](../phase6/real-application-compatibility-matrix.md) のsynchronized-output gapを参照して実施）
  （分割と完了条件は
  [`docs/phase9/synchronized-output-rendering.md`](../phase9/synchronized-output-rendering.md)
  を参照して順に実施する）
...
- [x] light/dark notification と extended reports
  （[`docs/phase6/real-application-compatibility-matrix.md`](../phase6/real-application-compatibility-matrix.md) のtheme report/update gapを参照して実施）
  （目的、境界、完了条件は
  [`docs/phase9/light-dark-notification-extended-reports.md`](../phase9/light-dark-notification-extended-reports.md)
  を参照して順に実施する）
...
- [x] Kitty graphics parse/storage/placement/render
  （分割、境界、完了条件は
  [`docs/phase9/kitty-graphics.md`](../phase9/kitty-graphics.md)
  を参照して順に実施する）
...
- [x] image animation と resource eviction
  （分割、境界、完了条件は
  [`docs/phase9/kitty-image-animation-resource-eviction.md`](../phase9/kitty-image-animation-resource-eviction.md)
  を参照して順に実施する）
...
- [x] desktop notification、progress、semantic prompt extensions
  （分割、境界、完了条件は
  [`docs/phase9/desktop-notification-progress-semantic-extensions.md`](../phase9/desktop-notification-progress-semantic-extensions.md)
  を参照して順に実施する）
...
- [x] OSC 52 confirmation/policy UI
  （分割、境界、完了条件は
  [`docs/phase9/osc52-confirmation-policy-ui.md`](../phase9/osc52-confirmation-policy-ui.md)
  を参照して順に実施する）
...
- [x] protocol-specific fuzz、security、memory tests
  （分割、境界、完了条件は
  [`docs/phase9/protocol-fuzz-security-memory.md`](../phase9/protocol-fuzz-security-memory.md)
  を参照して順に実施する）
...
- [x] split paneのRetina表示、drag resize同期、keyboard divider操作
  （分割、境界、完了条件は
  [`docs/phase7/split-pane-resolution-resize-controls.md`](../phase7/split-pane-resolution-resize-controls.md)
  を参照して順に実施する）
...
- [x] Quick Terminal と global shortcut
  （分割、境界、完了条件は
  [`docs/phase10/quick-terminal-global-shortcut.md`](../phase10/quick-terminal-global-shortcut.md)
  を参照して順に実施する）
...
- [x] Secure Keyboard Entry と auto/manual indication
  （分割、境界、完了条件は
  [`docs/phase10/secure-keyboard-entry.md`](../phase10/secure-keyboard-entry.md)
  を参照して順に実施する）
...
- [x] Quick Look、Services、drag/drop、context menu
  （分割、境界、完了条件は
  [`docs/phase10/quick-look-services-drag-drop-context-menu.md`](../phase10/quick-look-services-drag-drop-context-menu.md)
  を参照して順に実施する）
...
- [x] AppleScript dictionary と object lifecycle
  （分割、境界、完了条件は
  [`docs/phase10/applescript-dictionary-object-lifecycle.md`](../phase10/applescript-dictionary-object-lifecycle.md)
  を参照して順に実施する）
...
- [x] App Intents/Shortcuts、notifications
  （分割、境界、完了条件は
  [`docs/phase10/app-intents-shortcuts-notifications.md`](../phase10/app-intents-shortcuts-notifications.md)
  を参照して順に実施する）
...
- [x] `dart_appkit` から製品固有実装を分離する
  （分割、境界、完了条件は
  [`docs/phase10/dart-appkit-generic-boundary.md`](../phase10/dart-appkit-generic-boundary.md)
  を参照して順に実施する）
...
- [x] Reduce Motion/Contrast と localization
  （分割、境界、完了条件は
  [`docs/phase10/accessibility-display-localization.md`](../phase10/accessibility-display-localization.md)
  を参照して順に実施する）
...
- [x] terminal inspector と diagnostics bundle
  （分割、privacy境界、完了条件は
  [`docs/phase10/terminal-inspector-diagnostics-bundle.md`](../phase10/terminal-inspector-diagnostics-bundle.md)
  を参照して順に実施する）
...
- [x] AOT release、Universal Binary、resource layout
  （分割、bundle境界、完了条件は
  [`docs/phase11/aot-universal-resource-layout.md`](../phase11/aot-universal-resource-layout.md)
  を参照して順に実施する）
...
- [x] Developer ID signing、hardened runtime、notarization基盤
  ...
  [`docs/phase11/developer-id-notarization.md`](../phase11/developer-id-notarization.md)
  を参照して順に実施する）
...
- [x] update feed、署名検証、rollback
  （分割、鍵境界、完了条件は
  [`docs/phase11/signed-update-feed-rollback.md`](../phase11/signed-update-feed-rollback.md)
  を参照して順に実施する）
...
- [x] local crash report、hang sample、privacy-safe diagnostics
  （分割、privacy／symbol境界、完了条件は
  [`docs/phase11/local-crash-hang-diagnostics.md`](../phase11/local-crash-hang-diagnostics.md)
  を参照して順に実施する）
...
- [x] startup/input/render/parser/memory/power benchmark regression gate
  ...
  [`docs/phase11/product-performance-regression-gate.md`](../phase11/product-performance-regression-gate.md)
  を参照して順に実施する）
...
- [x] 24/72 hour soak、sleep/wake、display attach/detach、memory pressure
  ...
  [`docs/phase11/bounded-system-reliability.md`](../phase11/bounded-system-reliability.md)
  を参照して順に実施する）
...
- [x] native ASan/UBSan、fuzz corpus、fault injection
  ...
  [`docs/phase11/sanitizer-fuzz-fault-injection.md`](../phase11/sanitizer-fuzz-fault-injection.md)
  を参照して順に実施する）
...
- [x] Ghostty pinned matrix の P0/P1 gap burn-down
  ...
  [`docs/phase11/ghostty-p0-p1-gap-burn-down.md`](../phase11/ghostty-p0-p1-gap-burn-down.md)
  を参照して順に実施する）
  ...
  - [x] aggregate gate、文書／matrix更新、親項目完了判定
- [x] release candidate の daily-use program matrix
  （分割、program／workflow evidence、bounded duration境界、完了条件は
  [`docs/phase11/release-candidate-daily-use-program.md`](../phase11/release-candidate-daily-use-program.md)
  を参照して順に実施する）
  - [x] contract、program／evidence inventory、bounded-duration境界
  - [x] versioned daily-use matrix、fail-closed checker、通常gate統合
  - [x] bounded release-candidate aggregate、文書／matrix更新、Phase 11完了判定
...
- [x] Context Dock境界移動の既定キーをControl+Shift+Left／Rightへ変更する
  （実施時に
  [`docs/phase7/context-dock-boundary-shift-shortcut.md`](../phase7/context-dock-boundary-shift-shortcut.md)
  を参照する）
- [x] Context Dock幅変更時の二重境界を調査し古い境界の描画残りを解消する
  （実施時に
  [`docs/phase7/context-dock-divider-repaint.md`](../phase7/context-dock-divider-repaint.md)
  を参照して順に実施する）
...
- [x] 既存native-contentのprocess argv再表示／elapsed fixtureの非決定性を調査し検証を安定化する
  （実施時に
  [`docs/phase7/native-content-process-fixture-stability.md`](../phase7/native-content-process-fixture-stability.md)
  を参照する）
- [x] Context Dock境界のmouse dragを廃止し、Control+Left／Rightと固定倍率の幅追従へ移行する
  （実施時に
  [`docs/phase7/context-dock-keyboard-boundary-resize.md`](../phase7/context-dock-keyboard-boundary-resize.md)
  を参照して順に実施する）
  - [x] 汎用native split dividerのdrag無効化APIと回帰検証
  - [x] Context Dockのkeyboard幅操作、drag廃止、固定font／scaleの再layout、両runtimeと全体検証
- [x] windowの閉じるボタンで配下の全tab／paneを閉じ、pane Closeと分離する
  （実施時に
  [`docs/phase7/logical-window-close-all-tabs.md`](../phase7/logical-window-close-all-tabs.md)
  を参照して順に実施する）
  - [x] window単位の終了・aggregate確認・排他制御とモデル回帰検証
  - [x] 閉じるボタンへの接続、Command-Wの維持、両runtimeと全体の検証
- [x] 複数タブの通常Closeでフォーカス更新の衝突を防ぎ、最後のwindowを閉じてもappを保持する
  （実施時に
  [`docs/phase7/tabbed-window-close-focus-regression.md`](../phase7/tabbed-window-close-focus-regression.md)
  を参照する）
- [x] SettingsのEscによるモード切替／閉じる操作でビープを鳴らさない
  （実施時に
  [`docs/phase8/settings-escape-beep.md`](../phase8/settings-escape-beep.md)
  を参照して順に実施する）
...
- [x] 設定済みControl+Tabがtab切替へ届かない原因の特定
  （実施時に
  [`docs/phase7/control-tab-routing-diagnosis.md`](../phase7/control-tab-routing-diagnosis.md)
  を参照する）
- [x] SettingsのFn+Up／Downによる高速移動
  （実施時に
  [`docs/phase8/settings-function-page-navigation.md`](../phase8/settings-function-page-navigation.md)
  を参照する）
- [x] Context Dockの背景透過度をterminalと同じ単一背景合成へ揃える
  （実施時に
  [`docs/phase7/context-dock-background-compositing.md`](../phase7/context-dock-background-compositing.md)
  を参照する）
- [x] Xcode更新後に欠落したMetal Toolchainを復旧しRelease AOT buildを再検証する
  （実施時に
  [`docs/phase4/metal-toolchain-environment-recovery.md`](../phase4/metal-toolchain-environment-recovery.md)
  を参照する）
- [x] command paletteの選択境界とviewport追従の回帰修正
  （実施時に
  [`docs/phase7/command-palette-selection-viewport-regression.md`](../phase7/command-palette-selection-viewport-regression.md)
  を参照する）
- [x] terminal input ownershipに同期するContext DockのTerminal mode表示
  （実施時に
  [`docs/phase7/context-dock-terminal-mode.md`](../phase7/context-dock-terminal-mode.md)
  を参照する）
- [x] Option+Left／Rightによるshell word navigationの回帰修正
  （実施時に
  [`docs/phase5/option-arrow-word-navigation.md`](../phase5/option-arrow-word-navigation.md)
  を参照する）

### 完了機能の拡張

- [x] 全terminal surfaceで共有する背景透過度設定
  （分割、適用境界、完了条件は
  [`docs/phase8/terminal-background-opacity.md`](../phase8/terminal-background-opacity.md)
  を参照して順に実施する）
...
- [x] active paneのカーソル表示とinactive paneの視覚的な区別
  （分割、適用境界、完了条件は
  [`docs/phase7/active-pane-visual-focus.md`](../phase7/active-pane-visual-focus.md)
  を参照して順に実施する）
...
- [x] 方向別pane focus shortcutと上書き可能なdivider keybind
  （分割、適用境界、完了条件は
  [`docs/phase7/directional-pane-focus-keybindings.md`](../phase7/directional-pane-focus-keybindings.md)
  を参照して順に実施する）
...
- [x] Context Dockの隠しfile／folder表示切替
  （実施時に
  [`docs/phase7/context-dock-hidden-entries-toggle.md`](../phase7/context-dock-hidden-entries-toggle.md)
  を参照する）
...
- [x] Context Dock foreground process inspectorの成立性調査と設計
  （実施時に
  [`docs/phase7/context-dock-foreground-process-inspector.md`](../phase7/context-dock-foreground-process-inspector.md)
  を参照する）
- [x] Context Dock foreground process inspectorの実装
...
- [x] Process Inspectorの入力保護と情報表示を分離する
  （分割、境界、完了条件は
  [`docs/phase7/context-dock-process-input-privacy.md`](../phase7/context-dock-process-input-privacy.md)
  を参照して順に実施する）
...
- [x] Process Inspectorの一覧と詳細を単一表示へ統合し、Directory Navigatorの待機案内を除去する
  （実施時に
  [`docs/phase7/context-dock-process-inspector-unified-layout.md`](../phase7/context-dock-process-inspector-unified-layout.md)
  を参照する）
- [x] Process Inspectorの引用符付き引数に関する説明メッセージを除去する
  （実施時に
  [`docs/phase7/context-dock-process-argv-note-removal.md`](../phase7/context-dock-process-argv-note-removal.md)
  を参照する）
- [x] Context Dockの表示・幅設定とterminal styleの共有
  （実施時に
  [`docs/phase7/context-dock-configuration-and-appearance.md`](../phase7/context-dock-configuration-and-appearance.md)
  を参照して順に実施する）
...
- [x] focused paneに追従するContext Dockとlocal file／folder navigator
  ...
  [`docs/phase7/context-dock-file-navigator.md`](../phase7/context-dock-file-navigator.md)
  を参照して順に実施する）
  ...
  - [x] 通常Developer JIT起動のdirectory表示・検索・first responder回帰修正
    （実施時に
    [`docs/phase7/context-dock-developer-run-regression.md`](../phase7/context-dock-developer-run-regression.md)
    を参照する）
  - [x] Context Dockの既定幅拡大と固定details／scrollable listレイアウト
    （実施時に
    [`docs/phase7/context-dock-pinned-details-layout.md`](../phase7/context-dock-pinned-details-layout.md)
    を参照する）
  - [x] Context Dockの既定toggle shortcutとReturnによるfolder開閉
    （実施時に
    [`docs/phase7/context-dock-toggle-shortcut-folder-collapse.md`](../phase7/context-dock-toggle-shortcut-folder-collapse.md)
    を参照する）
  - [x] NavigatorのSearch／Go To／Move modeとnative input caret
    （実施時に
    [`docs/phase7/context-dock-navigator-modes.md`](../phase7/context-dock-navigator-modes.md)
    を参照する）
  - [x] Search／Go To resultからworking-directory treeへのrevealとfolder展開
    （実施時に
    [`docs/phase7/context-dock-navigator-modes.md`](../phase7/context-dock-navigator-modes.md)
    を参照する）
...
- [x] Context Dock作業ブランチをmainへ統合し、統合済みのローカルブランチを削除する
  （実施時に
  [`docs/phase7/context-dock-main-integration.md`](../phase7/context-dock-main-integration.md)
  を参照する）

### 主要ゴール後の低優先 follow-up

- [x] Directory Navigatorを各コマンド完了後と手動操作で更新する
  （実施時に
  [`docs/phase7/context-dock-directory-refresh.md`](../phase7/context-dock-directory-refresh.md)
  を参照して順に実施する）
...
- [x] Directory Navigatorの自動更新をcommand単位の一回に限定し、再取得中のちらつきを解消する
  （実施時に
  [`docs/phase7/context-dock-command-refresh-stability.md`](../phase7/context-dock-command-refresh-stability.md)
  を参照して順に実施する）
...
- [x] Developer ID配布のentitlementsをXMLで抽出し、現行codesignのplist正規化を通す
  （実施時に
  [`docs/phase11/codesign-entitlements-xml-extraction.md`](../phase11/codesign-entitlements-xml-extraction.md)
  を参照する）
- [x] 現行notarytoolの非wait submit JSONを厳密検証し、公証待機へ進める
  （実施時に
  [`docs/phase11/notarytool-submit-evidence-compatibility.md`](../phase11/notarytool-submit-evidence-compatibility.md)
  を参照する）
- [x] notarytool 1.1.3のsubmit／Accepted log応答variantを厳密に受理する
  （実施時に
  [`docs/phase11/notarytool-submit-message-variant.md`](../phase11/notarytool-submit-message-variant.md)
  を参照する）
  - [x] 句点なしupload成功messageをUUID／exact pathと組にして受理する
  - [x] Accepted logの`issues: null`をissue 0として正規化する
    （実施時に
    [`docs/phase11/notarytool-log-null-issues.md`](../phase11/notarytool-log-null-issues.md)
    を参照する）
  - [x] 実配布でwait、log、staple、Gatekeeper、最終監査を受け入れる
  - [x] distribution gap証跡をApple service受け入れからclean-machine no-rebuildへ更新する
    （実施時に
    [`docs/phase11/developer-id-evidence-transition.md`](../phase11/developer-id-evidence-transition.md)
    を参照する）
- [x] TerminalとContext Dockを表すmacOS application iconを生成し全bundleへ反映する
  （実施時に
  [`docs/phase11/application-icon.md`](../phase11/application-icon.md)
  を参照して順に実施する）
...
- [x] 複数行Paste確認後に先頭文字が重複して見える表示上のカーソルずれを解消する
  （実施時に
  [`docs/phase5/multiline-paste-confirmation-rendering.md`](../phase5/multiline-paste-confirmation-rendering.md)
  を参照する）
- [x] 未指定のfresh terminal working directoryをprocess cwdではなくユーザーhomeにする
  （実施時に
  [`docs/phase5/default-home-working-directory.md`](../phase5/default-home-working-directory.md)
  を参照する）
- [x] 実行中のContext DockをProcess InspectorとDirectory Navigatorの間で手動切替できるようにする
  （実施時に
  [`docs/phase7/context-dock-manual-content-switch.md`](../phase7/context-dock-manual-content-switch.md)
  を参照する）
- [x] Process InspectorからDirectory Navigatorへ手動切替できない実機不具合の原因を特定する
  （実施時に
  [`docs/phase7/context-dock-manual-switch-investigation.md`](../phase7/context-dock-manual-switch-investigation.md)
  を参照する）
...
- [x] appのfocus復帰後も実行中Process Inspectorから保持済みDirectory Navigatorへ手動切替できるよう修正する
  （実施時に
  [`docs/phase7/context-dock-focus-reactivation-switch.md`](../phase7/context-dock-focus-reactivation-switch.md)
  を参照する）
- [x] foreground process中に手動表示したDirectory Navigatorでtree移動と展開を操作できるようにする
  （実施時に
  [`docs/phase7/context-dock-foreground-directory-interaction.md`](../phase7/context-dock-foreground-directory-interaction.md)
  を参照する）
- [x] foreground process中のDirectory Navigator表示がprocess pollで解除される回帰を修正する
  （実施時に
  [`docs/phase7/context-dock-foreground-directory-override-stability.md`](../phase7/context-dock-foreground-directory-override-stability.md)
  を参照する）
- [x] split paneのfocus round trip後も実行中Process InspectorからDirectory Navigatorへ切替可能にする
  （実施時に
  [`docs/phase7/context-dock-pane-focus-directory-retention.md`](../phase7/context-dock-pane-focus-directory-retention.md)
  を参照する）
- [x] 同一windowのtab focus round trip後も実行中Process InspectorからDirectory Navigatorへ切替可能にする
  （実施時に
  [`docs/phase7/context-dock-tab-focus-directory-retention.md`](../phase7/context-dock-tab-focus-directory-retention.md)
  を参照する）
- [x] 全window／tab／split pane遷移でProcess InspectorとDirectory Navigatorの切替・refresh・設定keybindを安定化する
  （実施時に
  [`docs/phase7/context-dock-transition-action-reliability.md`](../phase7/context-dock-transition-action-reliability.md)
  を参照する）
...
- [x] READMEを英語の簡潔な起動・主要機能案内へ再構成する
  （実施時に
  [`docs/readme-product-overview.md`](../readme-product-overview.md)
  を参照する）
- [ ] native-content acceptanceのmanual Secure Keyboard Entry foreground activationを安定化する
  （実施時に
  [`docs/phase10/native-content-secure-input-activation.md`](../phase10/native-content-secure-input-activation.md)
  を参照する）
- [ ] 既存PTYのcompeting-reaper回帰fixtureの非決定性を調査し、実external-reap検証を安定化する
  （実施時に
  [`docs/phase2/pty-competing-reaper-fixture-determinism.md`](../phase2/pty-competing-reaper-fixture-determinism.md)
  を参照する）
