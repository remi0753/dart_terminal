...
void _testCompletePinnedInventory() {
  ...
  _expect(
    inventory.version == 1 &&
        ...
        support[TerminalCompatibilitySupport.implemented] == 81 &&
        support[TerminalCompatibilitySupport.partial] == 16 &&
        support[TerminalCompatibilitySupport.safeIgnore] == 10 &&
        support[TerminalCompatibilitySupport.unsupported] == 153,
    ...
    ecma.artifactBytes == 1607865 &&
        ...
        inventory.machineLine() ==
            'TERMINAL_COMPATIBILITY_INVENTORY_CHECK version=1 revision=2 '
                'sources=4 records=260 implemented=81 partial=16 '
                'safe_ignore=10 unsupported=153',
...
void _testImplementationSurfaceReconciliation() {
  ...
  _expect(
    inventory.reconcileImplementationSurface(manifest) ==
        'TERMINAL_COMPATIBILITY_RECONCILIATION_PASS implementation=97 '
