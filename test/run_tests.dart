...
import 'runtime_candidate_launch_test.dart';
import 'runtime_image_worker_test.dart';
import 'runtime_lifecycle_test.dart';
import 'runtime_stderr_filter_test.dart';
...
import 'terminal_note_r0_architecture_audit_test.dart';
...
import 'terminal_note_r1_qualification_test.dart';
import 'terminal_note_r1_rehearsal_test.dart';
...
import 'terminal_runtime_test_activation_test.dart';
...
Future<void> main() async {
  ...
  runTerminalNoteR0ArchitectureAuditTests();
  ...
  await runTerminalNoteR1RehearsalTests();
  runTerminalNoteR1QualificationTests();
  ...
  runRuntimeCandidateLaunchTests();
  runTerminalRuntimeTestActivationTests();
  runRuntimeStderrFilterTests();
