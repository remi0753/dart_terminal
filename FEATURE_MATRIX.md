...
| AX-02 | Full Keyboard Access、Reduce Motion、Increase Contrast、Differentiate Without Color | P0 | 5/10 | macOS Surface/Splits/QuickTerminal accessibility code | native menu、Command Palette、Settings、split/tab/window/Quick Terminalのkeyboard-only経路とterminal responder復元を自動受け入れし、Full Keyboard Access実機確認を[manual checklist](docs/phase10/voiceover-accessibility-manual-checklist.md)へ分離。Reduce Motion、Increase Contrast、Differentiate Without Colorは次のPhase 10項目 |
