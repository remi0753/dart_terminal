...
| REN-06 | vsync/frame pacing、cursor blink、occlusion pause、resume full redraw | P0 | 4 | `G:src/renderer/generic.zig`, `G:src/renderer/Thread.zig` | cursor/BELのrenderer-owned metadata入力を完了。animation clock、occlusion pause、resumeは現行ロードマップ項目で継続 |
