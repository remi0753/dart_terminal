...
| SCR-01 | primary/alternate screen、save/restore cursor、cursor shape/blink/visibility | P0 | 3 | `G:src/terminal/Screen.zig`, `G:src/terminal/ScreenSet.zig`, `G:src/terminal/cursor.zig` | bounded SoA visible screenとposition/rendition save/restore、shape/blink/visibilityを完了。primary/alternateは次subtask |
