...
| CAP-11 | Kitty graphics: transmit/storage/placement/z-index/scroll/erase/animation/eviction | P1 | 9 | `G:src/terminal/kitty/graphics*.zig`, `G:src/renderer/image.zig` | bounded APC grammar、process-worker direct RGB/RGBA/PNG+zlib decode、multipart/FIFO reply、主/代替画面別64 image・16 MiB storage、ID/number replacement、256 placement cap、static put/transmit-and-place、crop/grid/cursor、通常negative/positive z、全static delete selectorを完了。scroll/clear/reflow projection、virtual/relative/extreme-negative z、Metal、animation/evictionは後続 |
